...
public class MyGameListDatabaseHelper  extends SQLiteOpenHelper {
    ...
    private static void insertRPG(SQLiteDatabase db, String name, String description, String score, String developers, String publishers, String platforms, String rel_date, int resourceId, int type) {
        ...
        rpgValues.put("TYPE_ID", type);
        db.insert("RPG", null, rpgValues);
    }

    private static void insertAction(SQLiteDatabase db, String name, String description, String score, String developers, String publishers, String platforms, String rel_date, int resourceId, int type) {
        ...
        actionValues.put("TYPE_ID", type);
        db.insert("ACTIONS", null, actionValues);
    }

    private static void insertShooter(SQLiteDatabase db, String name, String description, String score, String developers, String publishers, String platforms, String rel_date, int resourceId, int type) {
    ...
    private void updateMyDatabase(SQLiteDatabase db, int oldVersion, int newVersion) {
        if (oldVersion < 1) {
            ...
            db.execSQL("CREATE TABLE USER_GAMES ("
                    + "_id INTEGER PRIMARY KEY AUTOINCREMENT, "
                    + "NAME TEXT, "
                    + "DESCRIPTION TEXT, "
                    + "SCORE TEXT,"
            ...
            insertRPG(db, "Yakuza Like a Dragon", "Ichiban Kasuga, born and raised in a soapland in Kamurocho " +
                    ...
                    "9.5", "Ryu ga Gotoku Studio", "Sega", "PS4, PS5, Xbox One, \nXbox Series X/S, PC", "16/01/2020",R.drawable.yakuza7cover,1);
            ...
            insertAction(db,"The Legend of Zelda Breath of the Wild", "Link awakens from his slumber in the " +
                    ...
                    "9.9", "Nintendo EPD", "Nintendo", "Nintendo Switch", "03/03/2017", R.drawable.botwcover,2);
            ...
            insertAction(db, "Persona 5 Strikers", "After a few months after the events ofn Persona 5, its group of protagonists meet again" +
                    ...
                    "8.8", "Atlus, Koei Techmo", "Sega", "Nintendo Switch, PS4, PC", "20/02/2020", R.drawable.p5scover, 2);
            ...
            insertShooter(db,"Metroid Prime", "The game takes place on the planet Tallon IV, formerly inhabited by the Chozo race." +
                    ...
                    "9.5", "Retro Studios", "Nintendo", "Nintendo Gamecube", "18/11/2002", R.drawable.metroidprimecover, 3);
